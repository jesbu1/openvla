...
def rl_bench_v1_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    # rl_bench_v1:
    "rl_bench_v1": rl_bench_v1_dataset_transform,
    ...
    "libero_90_openvla_processed": libero_dataset_transform,
    "libero_90_rlds_no_noops": libero_dataset_transform,
